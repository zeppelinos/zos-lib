...
contract SampleMotherV1 is Migratable {
  ...
  function initialize(uint256 value)
    isInitializer("Mother", "migration_1")
    public
  {
    mother = value;
  }
...
contract SampleMotherV2 is SampleMotherV1 {
  function migrate(uint256 value)
    isMigration("Mother", "migration_1", "migration_2")
    public
  {
    mother = value;
  }
...
contract SampleGrampsV1 is Migratable {
  ...
  function initialize(uint256 value)
    isInitializer("Gramps", "migration_1")
    public
  {
    gramps = value;
  }
...
contract SampleGrampsV2 is SampleGrampsV1 {
  function migrate(uint256 value)
    isMigration("Gramps", "migration_1", "migration_2")
    public
  {
    gramps = value;
  }
...
contract SampleFatherV1 is SampleGrampsV1 {
  ...
  function initialize(uint256 _gramps, uint256 _father)
    isInitializer("Father", "migration_1")
    public
  {
...
contract SampleFatherV2 is SampleFatherV1, SampleGrampsV2 {
  function migrate(uint256 _gramps, uint256 _father)
    isMigration("Father", "migration_1", "migration_2")
    public
  {
...
contract SampleChildV1 is Migratable, SampleMotherV1, SampleFatherV1 {
  ...
  function initialize(
    ...
    isInitializer("Child", "migration_1")
    public
  {
...
contract SampleChildV2 is SampleChildV1 {
  function migrate(uint256 _child)
    isMigration("Child", "migration_1", "migration_2")
    public
  {
    child = _child;
  }
...
contract SampleChildV3 is SampleChildV2, SampleMotherV2 {
  function migrate(uint256 _mother, uint256 _child)
    isMigration("Child", "migration_2", "migration_3")
    public
  {
...
contract SampleChildV4 is SampleChildV3, SampleFatherV2 {
  function migrate(
    ...
    isMigration("Child", "migration_3", "migration_4")
    public
  {
...
contract SampleChildV5 is SampleChildV4 {
  function initialize(
    ...
    isInitializer("Child", "migration_5")
    public
  {
    SampleMotherV1.initialize(_mother);
    SampleMotherV2.migrate(_mother);
  ...
  function migrateFromV3(
    ...
    isMigration("Child", "migration_3", "migration_5")
    public
  {
  ...
  function migrate(uint256 _child)
    isMigration("Child", "migration_4", "migration_5")
    public
  {
    child = _child;
  }
