...
contract SampleMotherV1 is Migratable {
  ...
  function initialize(uint256 value) isInitializer("Mother", "V1") public {
    mother = value;
  }
}
...
contract SampleMotherV2 is SampleMotherV1 {
  function migrate(uint256 value) isMigration("Mother", "V1", "V2") public {
    mother = value;
  }
}
...
contract SampleGrampsV1 is Migratable {
  ...
  function initialize(uint256 value) isInitializer("Gramps", "V1") public {
    gramps = value;
  }
}
...
contract SampleGrampsV2 is SampleGrampsV1 {
  function migrate(uint256 value) isMigration("Gramps", "V1", "V2") public {
    gramps = value;
  }
}
...
contract SampleFatherV1 is SampleGrampsV1 {
  ...
  function initialize(uint256 _gramps, uint256 _father) isInitializer("Father", "V1") public {
...
contract SampleFatherV2 is SampleFatherV1, SampleGrampsV2 {
  function migrate(uint256 _gramps, uint256 _father) isMigration("Father", "V1", "V2") public {
...
contract SampleChildV1 is Migratable, SampleMotherV1, SampleFatherV1 {
  ...
  function initialize(uint256 _mother, uint256 _gramps, uint256 _father, uint256 _child) isInitializer("Child", "V1") public {
...
contract SampleChildV2 is SampleChildV1 {
  function migrate(uint256 _child) isMigration("Child", "V1", "V2") public {
    child = _child;
  }
}
...
contract SampleChildV3 is SampleChildV2, SampleMotherV2  {
  function migrate(uint256 _mother, uint256 _child) isMigration("Child", "V2", "V3") public {
...
contract SampleChildV4 is SampleChildV3, SampleFatherV2  {
  function migrate(uint256 _gramps, uint256 _father, uint256 _child) isMigration("Child", "V3", "V4") public {
...
contract SampleChildV5 is SampleChildV4 {
  function initialize(uint256 _mother, uint256 _gramps, uint256 _father, uint256 _child) isInitializer("Child", "V5") public {
    SampleMotherV1.initialize(_mother);
    SampleMotherV2.migrate(_mother);
    SampleFatherV1.initialize(_gramps, _father);
    SampleFatherV2.migrate(_gramps, _father);
  ...
  function migrateFromV3(uint256 _gramps, uint256 _father, uint256 _child) isMigration("Child", "V3", "V5") public {
    SampleChildV4.migrate(_gramps, _father, _child);
  }

  function migrate(uint256 _child) isMigration("Child", "V4", "V5") public {
    child = _child;
  }
}